...
{
public:
    void Init(UART_HandleTypeDef *huart, Enum_Serialplot_Checksum_8 __Checksum_8 = Serialplot_Checksum_8_ENABLE, uint8_t __Rx_Variable_Assignment_Num = 0, char **__Rx_Variable_Assignment_List = NULL, Enum_Serialplot_Data_Type __Tx_Data_Type = Serialplot_Data_Type_FLOAT, uint8_t __Frame_Header = 0xab);
